...
namespace Services
{
    public class PersonServices : IPersonsServices
    {
        ...
        public PersonServices(bool initialize)
        {
            _persons = new List<Person>();
            _countriesService = new CountryServices(true);
        ...
        {
            return _persons.Select(temp => ConvertPersonToResponseWithCountry(temp) ).ToList();
        }
